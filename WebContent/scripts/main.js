(function() {
    ...
    ajax('GET', url, req,
      ...
      function(res) {
        ...
        if (result.status === 'OK') {
          ...
          hideElement(document.querySelector("#signup-form"));
        }
      },
      // error
      function() {
  ...
  function signup(){
        ...
        '<input id="signup-username" name="signup-username" type="text">'+
        '<label for="signup-password">Password:</label>'+
        '<input id="signup-password" name="signup-password" type="password">'+'<label for="lastname">Lastname:</label>' +
        '<input id="lastname" name="lastname" type="text">' +
        '<label for="firstname">FirstName:</label>' +
        '<input id="firstname" name="firstname" type="text">'+
        '<button id="register-btn">Sign Up</button>' +'<button id="back-btn">Back</button>'
        +'<br><p id="signup-error"></p>';
	  	showElement(document.querySelector("#signup-form"));
	  	hideElement(document.querySelector("#login-form"));
	  	document.querySelector('#register-btn').addEventListener('click', register);
	  	document.querySelector('#back-btn').addEventListener('click', back);
  }
  function back(){
	  showElement(document.querySelector("#login-form"));
	  hideElement(document.querySelector("#signup-form"));
  }
  function register(){
	    ...
	    password = md5(username + md5(password));
	    if(!validateInfo(username, password, firstname, lastname)){
	    	showSignupError();
	    	return;
	    }
	    // The request parameters
  ...
  function validateInfo(userid, password, firstname, lastname){
	  if(userid == '' || password == ''){
		  return false;
	  }
	  return true;
  ...
  function showSignupError() {
	    document.querySelector('#signup-error').innerHTML = 'Invalid Information';
	  }
