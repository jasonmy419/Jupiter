...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "4iuiLiONCCyAQu7AzDIGAWqGF488z2Bw";
    ...
    private List<Item> getItemList(JSONArray events) throws JSONException {
		...
		for(int i = 0; i < events.length(); i++) {
			...
			if(!event.isNull("rating")) {
				itemBuilder.setRating(event.getDouble("rating"));
			}
			itemBuilder.setAddress(getAddress(event));
